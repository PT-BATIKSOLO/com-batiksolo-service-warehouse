...
//using Com.BatikSolo.Service.Purchasing.Lib.ViewModels.IntegrationViewModel;
//using Com.BatikSolo.Service.Purchasing.Lib.ViewModels.PurchaseOrder;
//using Com.BatikSolo.Service.Purchasing.Lib.ViewModels.UnitPaymentCorrectionNoteViewModel;
//using Com.BatikSolo.Service.Purchasing.Lib.ViewModels.UnitReceiptNote;
...
using System.Text;
//using Com.BatikSolo.Service.Purchasing.Lib.Facades.GarmentExternalPurchaseOrderFacade.Reports;
//using Com.BatikSolo.Service.Purchasing.Lib.Facades.GarmentUnitDeliveryOrderReturFacades;
//using Com.BatikSolo.Service.Purchasing.Lib.Facades.GarmentReceiptCorrectionFacades;
//using Com.BatikSolo.Service.Purchasing.Lib.Facades.MonitoringCentralBillReceptionFacades;
//using Com.BatikSolo.Service.Purchasing.Lib.Facades.MonitoringCentralBillExpenditureFacades;
//using Com.BatikSolo.Service.Purchasing.Lib.Facades.MonitoringCorrectionNoteReceptionFacades;
using FluentScheduler;
using Com.BatikSolo.Service.Warehouse.WebApi.SchedulerJobs;
using Com.BatikSolo.Service.Warehouse.Lib.Utilities.CacheManager;
//using Com.BatikSolo.Service.Purchasing.Lib.Facades.MonitoringCorrectionNoteExpenditureFacades;
//using Com.BatikSolo.Service.Purchasing.Lib.Facades.GarmentPOMasterDistributionFacades;
//using Com.BatikSolo.Service.Purchasing.Lib.Facades.GarmentReports;
...
//using Com.BatikSolo.Service.Purchasing.Lib.Facades.PRMasterValidationReportFacade;
//using Com.BatikSolo.Service.Purchasing.Lib.Facades.GarmentExternalPurchaseOrderFacades.Reports;
//using Com.BatikSolo.Service.Purchasing.Lib.Facades.GarmentSupplierBalanceDebtFacades;

namespace Com.BatikSolo.Service.Warehouse.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "BatikSoloWareHouse API", Version = "v1" });
